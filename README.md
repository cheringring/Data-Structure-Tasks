...
## 프로젝트 개요
이 프로젝트는 C로 구현된 멀티스레드 웹 크롤러와 Python Flask 기반의 웹 인터페이스를 결합하여 웹사이트의 링크 구조를 크롤링하고 시각화하는 시스템입니다. 자료구조와 알고리즘의 실제 응용을 보여주는 프로젝트로, 그래프 이론, 해시 테이블, 큐 등의 자료구조를 활용합니다.
<br>
